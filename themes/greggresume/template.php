...
function gregg_resume_theme_user_reference_field_formatter_view($entity_type, $entity, $field, $instance, $langcode, $items, $display) {
  $result = array();
...
function gregg_resume_preprocess_html(&$vars) {
...
function gregg_resume_preprocess_page(&$vars) {
