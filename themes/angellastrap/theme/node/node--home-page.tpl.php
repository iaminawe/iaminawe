...
?>
  ...
  <! -- ABOUT SEPARATOR -->
  <div class="sep" style="background: url('<?php print $aboutimagepath ?>')" data-stellar-background-ratio="0.55"></div>
  ...
  <! -- PORTFOLIO SEPARATOR -->
  <div class="sep" style="background: url('<?php print $portfolioimagepath ?>')" data-stellar-background-ratio="0.5"></div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-8-offset-2 centered">
          ...
          <h3>I will help you with all your design and illustration needs</h3>
          <p>Let me tell you more about my offerings</p>
        </div><!-- /col-lg-8 -->
